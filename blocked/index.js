        ...
        eachMessage: async ({ topic, partition, message }) => {
            if (message.value){
                ...
                if (black_list.includes(data.user)){
                    console.log(new Date(data.time).toLocaleDateString("es-CL"), new Date(data.time).toLocaleTimeString("es-CL"), data.user, "esta baneado (esta incluido en la blacklist).");
